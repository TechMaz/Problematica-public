...
if os.environ.get("IS_TEST",None):
    ...
    import datetime
    test_db.define_table('problems_by_user',
                    Field('user_id', type='integer'),
                    Field('problem_id', type='integer'))

    test_db.define_table('images',
        Field('picture', 'upload', uploadfield='picture_file'),
        Field('picture_file', 'blob'),
    	Field('owner_id', type='integer')
    )

    test_db.define_table('problems',
                    Field('id'),
    ...
    #                Field('initial_bounty', type='double', default=0),
                    ...
                    Field('subject', requires=IS_IN_DB(test_db,'topics.topic_name')),
                    Field('institution', type='integer', default=auth.user_id)
    )

    test_db.define_table('donations',
                    Field('id'),
    ...
    test_db.define_table('solutions',
                    Field('id'),
